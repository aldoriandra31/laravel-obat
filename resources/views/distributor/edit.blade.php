        ...
        <div class="col">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-vertical" action="{{ route('distributor-obats.update', $distributor_obat) }}"
                            method="post">
                            @method('put')
                            @csrf
                            <div class="form-body">
                                        ...
                                        <div class="form-group has-icon-left">
                                            ...
                                            <div class="position-relative">
                                                <input name="kode_distributor" type="text" class="form-control"
                                                    ...
                                                    value="{{ old('kode_distributor', $distributor_obat->kode_distributor) }}" />
                                        ...
                                        <div class="form-group has-icon-left">
                                            ...
                                            <div class="position-relative">
                                                <input name="nama_distributor" type="text" class="form-control"
                                                    placeholder="Nama Kategori Pembayaran" id="first-name-icon"
                                                    value="{{ old('nama_distributor', $distributor_obat->nama_distributor) }}" />
                                                <div class="form-control-icon">
                                                    <i class="bi bi-person"></i>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group has-icon-left">
                                            ...
                                            <div class="position-relative">
                                                <input name="alamat_distributor" type="text" class="form-control"
                                                    placeholder="Nama Kategori Pembayaran" id="first-name-icon"
                                                    value="{{ old('alamat_distributor', $distributor_obat->alamat_distributor) }}" />
                                                <div class="form-control-icon">
                                                    <i class="bi bi-person"></i>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group has-icon-left">
                                            ...
                                            <div class="position-relative">
                                                <input name="telp_distributor" type="text" class="form-control"
                                                    placeholder="Nama Kategori Pembayaran" id="first-name-icon"
                                                    value="{{ old('telp_distributor', $distributor_obat->telp_distributor) }}" />
                                                <div class="form-control-icon">
                                                    <i class="bi bi-person"></i>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group has-icon-left">
                                            ...
                                            <div class="position-relative">
                                                <input name="latitude" type="text" class="form-control"
                                                    placeholder="Nama Kategori Pembayaran" id="first-name-icon"
                                                    value="{{ old('latitude', $distributor_obat->latitude) }}" />
                                                <div class="form-control-icon">
                                                    <i class="bi bi-person"></i>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group has-icon-left">
                                            ...
                                            <div class="position-relative">
                                                <input name="longitude" type="text" class="form-control"
                                                    placeholder="Nama Kategori Pembayaran" id="first-name-icon"
                                                    value="{{ old('longitude', $distributor_obat->longitude) }}" />
                                                <div class="form-control-icon">
                                                    <i class="bi bi-person"></i>
                                                </div>
                                            </div>
